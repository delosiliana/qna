...
(function() { this.JST || (this.JST = {}); this.JST["templates/answer"] = (function() {
    this.Skim = {
      access: function(name) {
        var value;
        value = this[name];
    ...
    return function(context) {
      ...
      return Skim.withContext.call({}, context, function() {
        var _buf, attachment, i, len, ref;
        _buf = '';
        if (this.answer.user_id !== gon.user_id) {
          _buf += "\u003cdiv class=\"answer-";
          _buf += this.escape(this.answer.id);
          _buf += "\"\u003e";
          if (gon.user_id === gon.question_user_id) {
            _buf += "\u003ca class=\"best-answer-link\" data-method=\"patch\" data-remote=\"true\" href=\"/answers/";
            _buf += this.escape(this.answer.id);
            _buf += "/best\" rel=\"nofollow\"\u003eNote as best\u003c/a\u003e";
          }
          _buf += "\u003cdiv class=\"total_votes\"\u003e\u003cdiv class=\"";
          _buf += this.escape(this.answer);
          _buf += "-total_votes-";
          _buf += this.escape(this.answer.id);
          _buf += "\"\u003e";
          _buf += this.escape("Votes: " + this.total_votes);
          _buf += "\u003c/div\u003e";
          if (gon.user_id && gon.user_id !== this.answer.user_id) {
            _buf += "\u003cdiv class=\"links\"\u003e\u003cp class=\"vote_up vote\"\u003e\u003c/p\u003e\u003ca data-method=\"post\" data-remote=\"true\" href=\"/answers/";
            _buf += this.escape(this.answer.id);
            _buf += "/vote_up\" rel=\"nofollow\"\u003evote up\u003c/a\u003e\u003cp class=\"vote_down vote\"\u003e\u003c/p\u003e\u003ca data-method=\"post\" data-remote=\"true\" href=\"/answers/";
            _buf += this.escape(this.answer.id);
            _buf += "/vote_down\" rel=\"nofollow\"\u003evote down\u003c/a\u003e\u003c/div\u003e";
          }
          _buf += "\u003c/div\u003e\u003cp id=\"answers\"\u003e";
          _buf += this.escape(this.answer.body);
          _buf += "\u003c/p\u003e\u003cdiv class=\"attachments\"\u003e";
          ref = this.attachments;
          for (i = 0, len = ref.length; i < len; i++) {
            attachment = ref[i];
            _buf += "\u003cdiv id=\"attachment-file-";
            _buf += this.escape(attachment.id);
            _buf += "\"\u003e\u003ca href=\"";
            _buf += this.escape(attachment.file.url);
            _buf += "\"\u003e";
            _buf += this.escape(attachment.file_name);
            _buf += "\u003c/a\u003e\u003c/div\u003e";
          }
          _buf += "\u003c/div\u003e\u003c/div\u003e";
        }
...
(function() { this.JST || (this.JST = {}); this.JST["templates/comment"] = (function() {
    this.Skim = {
      access: function(name) {
        var value;
        value = this[name];
    ...
    return function(context) {
      ...
      return Skim.withContext.call({}, context, function() {
        var _buf;
        _buf = '';
        _buf += "\u003cdiv class=\"comment_";
        _buf += this.escape(this.comment.id);
        _buf += " comment\"\u003e";
        _buf += this.escape(this.comment.body);
        _buf += "\u003c/div\u003e";
        return _buf;
      });
    };
...
(function() { this.JST || (this.JST = {}); this.JST["templates/test"] = (function() {
    this.Skim = {
      access: function(name) {
        var value;
        value = this[name];
...
(function() {
  $(function() {
    $(document).on('click', '.edit-answer-link', function(e) {
      ...
      return $('form#edit-answer-' + answerId).show();
    });
    return App.cable.subscriptions.create({
      ...
      connected: function() {
        ...
        this.perform('follow');
        return console.log('Good connect');
      },
...
(function() {
  $(function() {
    $(document).on('click', '.add-comment-link', function(e) {
      var resource_id, resource_type;
      e.preventDefault();
      $(this).hide();
      resource_id = $(this).data('resourceId');
      resource_type = $(this).data('resourceType');
      return $('form#new_comment_' + resource_type + '_' + resource_id).show();
    });
    $(document).on('click', '.edit-comment-link', function(e) {
      ...
      return $('form#edit_comment_' + comment_id).show();
    });
    return App.cable.subscriptions.create({
      ...
      connected: function() {
        ...
        question_id = $('.question').data('id');
        this.perform('follow');
        return console.log('Good connect comments');
      },
      received: function(data) {
        var commentable_id, commentable_type, comments;
        ...
        return $(comments).append(JST["templates/comment"]({
...
(function() {
  $(function() {
    $('.vote').bind('ajax:success', function(e) {
      ...
      return $('.error_vote').html("");
    });
    return $('.vote').bind('ajax:error', function(e) {
      return $('.error_vote').html(e.detail[0]);
    });
  });
